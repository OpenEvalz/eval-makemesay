#!/usr/bin/env python3
"""Run ONE problem of makemesay through TrustedRouter and emit a reproducibility bundle.
...
def main() -> int:
    ap = argparse.ArgumentParser(description="Run one makemesay problem via TrustedRouter")
