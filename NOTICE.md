...
`eval-makemesay` packages an evaluation from **inspect_evals**.

- **Upstream:** https://github.com/UKGovernmentBEIS/inspect_evals (`src/inspect_evals/makemesay`)
...
- `direct_url`: `https://github.com/openai/evals/raw/{SHA}/evals/registry/data/make_me_say/`
